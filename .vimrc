...
"For Linux yanking to clipboard
"set clipboard=unnamedplus
"
"For Mac OSX yanking to clipboard
...
" -----------------------------------------------------------------
" Map the current Application to safari
" ----------------------------------------------------------------
"
"
"nnoremap <F12>s :exe ':silent !open /Applications/Safari.app %'<CR>

nmap <silent> <leader>w :exec ':silent !open /Applications/Safari.app % &' 
" 'silent !google-chrome % &'
